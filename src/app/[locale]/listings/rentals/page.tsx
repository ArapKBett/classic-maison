    ...
    <div className="pt-24 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-10">
          ...
          <h1 className="font-serif text-4xl lg:text-5xl font-bold text-ink mb-2">{t('nav.rentals')}</h1>
          <p className="text-ink-muted">Premium furnished and serviced rentals — short and long term leases available.</p>
        </div>
